...
def load_data(feature='cadets_data',numberOfNeighK=3):
    ...
    def getType(row):
        tp = row['type']
        feature_dir = f'/home/yhf/sghunter/node_feature/cadets_data/'
...
def generate_sghunter_dataset():
    ...
    detections = read_txt_file('/home/yhf/sghunter/query_graph/graph/cadets/detection_cadets.txt')
    path_to_uuid = {}
    uuid_all=[]

    # #抽象节点以及合并重复节点
    # with open('/home/yhf/sghunter/node_feature/cadets_data/all_nodes_data.csv', 'r') as csvfile:
    ...
    #定位关键节点
    with open('/home/yhf/sghunter/node_feature/cadets_data/nodes_data.csv', 'r') as csvfile:
        reader = csv.DictReader(csvfile)
        for row in reader:
            path = row['path']
            uuid_node = row['uuid']
    ...
    path = '/home/yhf/sghunter/query_graph/graph/cadets/node_prograph/'
    train_dataset = {}
    test_dataset = {}
...
if __name__ == '__main__':
    ...
    args.hidden_dim = 16
    args.n_layers = 4
    args.model_path = '/home/yhf/sghunter/ckpt/SeedGNN-model-cadets-trained.pth'
    args.filename = 'cadets'
    # layers = [3,4,5,6,7]
    # val_acc = []
    # for layer in layers:
    #     args.n_layers = layer
    #     args.model_path = f'/home/yhf/sghunter/ckpt/cadets-{layer}.pth'
    ...
    # path = "/home/yhf/sghunter/ckpt/SeedGNN-model-cadets-trained.pth"
