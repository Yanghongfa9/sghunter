...
def create_neg_query(graphs,org_node,isTrain,nodes_data,posQueryHashStats,posQueryHashes=None,hash2graph=None,hash2seed=None,recursiveCount=0):
    ...
    if len(candidate_paths) > 0:
        ...
        neg_seed1 = random.choices(hash2seed[neg_path_hashes])[0]
